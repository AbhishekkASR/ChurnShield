...
#  File    : AbhishekSingh_ChurnShield.py
#
#  NOTE: This file is an exact copy of app.py submitted as the required
#        named deliverable. The deployed application continues to run via
#        app.py (https://churnshieldbharatcares.streamlit.app/).
# =============================================================================
